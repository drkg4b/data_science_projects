...
For example: if you code everything in a Jupyter notebook and use that for the presentation that is totally great (no powerpoint needed). If you choose to code in any other editor and show that, it may work fine as well. If you need, use Powerpoint for the presentation but it is not mandatory. 